...
app.get("/news", async (req, res) => {
    ...
    try {
        ...
        } else if (website === "sky-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46070599d3be50dc47d16188b9c0e0c2f66ff&q=https://news.sky.com/ `;
        } else if (website === "nypost-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46055dd31b8f4667dc66d976f583b226b4150&q=https://nypost.com/ `;
        } else if (website === "tribune-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46055dd31b8f4667dc66d976f583b226b4150&q=https://www.tribuneindia.com/`;
        } else if (website === "quint-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46055dd31b8f4667dc66d976f583b226b4150&q=https://www.thequint.com/`;
        } else if (website === "msnbc-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46129c615d767bb4bf245e4fe94dba43e26a4&q=https://www.msnbc.com/`;
        } else if (website === "abc-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46129c615d767bb4bf245e4fe94dba43e26a4&q=https://www.abc.net.au/`;
        } else if (website === "latimes-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46129c615d767bb4bf245e4fe94dba43e26a4&q=https://www.latimes.com/`;
        } else if (website === "ctv-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46129c615d767bb4bf245e4fe94dba43e26a4&q=https://www.ctvnews.ca/`;
        } else if (website === "sun-news") {
            apiUrl = `https://newsdata.io/api/1/news?apikey=pub_46129c615d767bb4bf245e4fe94dba43e26a4&q=https://www.thesun.co.uk/news/`;
        } else {
        ...
        if (website === "ht-news" || website === "toi-news") {
            ...
            parseString(xml, async (err, result) => {
                if (err) {
                    return res
                        .status(500)
                        .json({ error: "Failed to parse XML" });
                }
            ...
            if (
                (website === "cnn-news" || website === "bbc-news") &&
                data.status === "ok"
            ) {
                articles = data.articles.slice(0, 10);
            } else if (
                website === "guardian-news" &&
                ...
                website === "livemint-news" ||
                website === "ie-news" ||
                website === "nbc-news" ||
                website === "thehindu-news" ||
                website === "zee-news" ||
                website === "wp-news" ||
                website === "forbes-news" ||
                website === "fox-news" ||
                ...
                website === "time-news" ||
                website === "vox-news" ||
                website === "indiatoday-news" ||
                website === "dc-news" ||
                website === "ndtv-news" ||
                website === "huffpost-news" ||
                website === "dna-news" ||
                website === "abp-news" ||
                website === "newsweek-news" ||
                website === "firstpost-news" ||
                website === "bi-news" ||
                website === "ign-news" ||
                website === "npr-news" ||
                website === "wsj-news" ||
                ...
                website === "sky-news" ||
                website === "nypost-news" ||
                website === "tribune-news" ||
                website === "quint-news" ||
                website === "msnbc-news" ||
                website === "abc-news" ||
                website === "latimes-news" ||
                website === "ctv-news" ||
                website === "sun-news"
            ) {
                articles = data.results.slice(0, 10);
                ...
                throw new Error(
                    `Failed to fetch news headlines from ${website}`,
                );
            }
...
async function getSentiment(title) {
    try {
        const sentimentAPI =
            "https://xhkc56io19.execute-api.us-east-1.amazonaws.com/dev";
