...
app.get('/news', async (req, res) => {
    ...
    try {
        ...
        } else if (website === 'washingtonpost-news') {
        ...
        if (website === 'ht-news' || website === 'toi-news') {
            ...
            } else if (website === 'livemint-news' || website === 'ie-news' || website === 'nbc-news' || website === 'thehindu-news' || website === 'zee-news' || website === 'washingtonpost-news') {
                articles = data.results.slice(0, 10);
            } else {
