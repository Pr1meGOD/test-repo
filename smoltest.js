...
app.get('/news', async (req, res) => {
    try {
        const apiKey = 'pub_46055dd31b8f4667dc66d976f583b226b4150';
        const response = await fetch(`https://newsdata.io/api/1/news?apikey=pub_46055dd31b8f4667dc66d976f583b226b4150&q=https://www.businessinsider.in&language=en`);
