...
app.get('/news', async (req, res) => {
    try {
        const apiKey = 'pub_45702963c65c4021894ccf1858d05f001f0e0';
        const response = await fetch(`https://newsdata.io/api/1/news?apikey=pub_45702963c65c4021894ccf1858d05f001f0e0&q=https://www.washingtonpost.com/&language=en `);
