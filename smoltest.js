...
app.get('/news', async (req, res) => {
    ...
    try {
        ...
        if (website === 'livemint') {
            ...
            if (website === 'cnn-news') {
                apiUrl = 'https://newsapi.org/v2/top-headlines?sources=cnn&apiKey=e382cf0baf104c3ca084d880a340dfa9';
            } else if (website === 'bbc-news') {
                apiUrl = 'https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=8299ddae71074acd8232edcfef9b7fb8';
            } else if (website === 'guardian-news') {
                apiUrl = 'https://content.guardianapis.com/search?api-key=4c73a5e6-93d1-4051-8e96-933b8d4fa06b';
            } else if (website === 'nytimes-news') {
                apiUrl = 'https://api.nytimes.com/svc/topstories/v2/home.json?api-key=LMv5Elsw8GmMHGOhyr3MQTuSGHNWgxgu';
